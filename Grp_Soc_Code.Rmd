...
grpyr_df<-grpyr_df%>%
  rowwise()%>%
  mutate(foodtype=ifelse(start>as.Date('1999-01-01'),list(count_foodcode_new(sub_members_df)),list(count_foodcode_old(sub_members_df))))

# got the final dataframe with food types
grpyr_df<-grpyr_df%>%
